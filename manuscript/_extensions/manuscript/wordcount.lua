-- Code originally written by Pandoc, then modified by Christopher T. Kenny
-- https://github.com/pandoc/lua-filters/blob/master/wordcount/wordcount.lua
-- https://github.com/christopherkenny/apsr/blob/main/_extensions/apsr/wordcount.lua
-- It was distributed under the MIT license, see
-- https://github.com/christopherkenny/apsr/blob/main/LICENSE.md
